...
class VersoesTest extends TestCase
{
    public function test_lists_releases_newest_first_and_tracks_the_first_commit(): void
    {
        ...
        $this->assertSame('0.7.1', $versoes[0]);
        $this->assertContains('0.1.0', $versoes);
        $this->assertSame('0.7.1', Versoes::numeroAtual());
        $this->assertSame('README: alinhamento com skills-metodologia', Versoes::atual()['titulo']);
